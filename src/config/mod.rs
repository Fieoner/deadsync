...
pub use deadsync_config::options::{
...
use deadsync_config::audio::AudioOptions as AudioConfigOptions;
...
use deadsync_config::null_or_die::NullOrDieOptions as NullOrDieConfigOptions;
use deadsync_config::options::{
    RuntimeOptions as RuntimeConfigOptions, SelectMusicOptions as SelectMusicConfigOptions,
    SystemOptions as SystemConfigOptions,
};
use deadsync_config::theme::{
    MachineFlowOptions as MachineFlowConfigOptions,
    ThemePresentationOptions as ThemePresentationConfigOptions,
};
...
impl Default for Config {
    fn default() -> Self {
        let system = SystemConfigOptions::default();
        let theme = ThemePresentationConfigOptions::default();
        let machine = MachineFlowConfigOptions::default();
        let null_or_die = NullOrDieConfigOptions::default();
        let select_music = SelectMusicConfigOptions::default();
        let audio = AudioConfigOptions::default();
        let runtime = RuntimeConfigOptions::default();
