...
pub const ITEMS: &[Item] = &[
    ...
    Item {
        ...
        help: &[
            ...
            HelpEntry::Bullet(lookup_key("OptionsLights", "SimplifyBass")),
        ],
    },
    Item {
        ...
        help: &[
            ...
            HelpEntry::Bullet(lookup_key("OptionsMachine", "NiceSound")),
    ...
    Item {
        ...
        help: &[
            ...
            HelpEntry::Bullet(lookup_key("OptionsSelectMusic", "SongSelectBG")),
            ...
            HelpEntry::Bullet(lookup_key("OptionsSelectMusic", "StepArtistBox")),
